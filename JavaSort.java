...
class Student implements Comparable<Student>{
    ...
    public int compareTo(Student n) {
        int cgpaCmp = (cgpa > n.cgpa) ? -1 : ((cgpa < n.cgpa) ? 1 : 0)  ;
        int fnameCmp = fname.compareTo(n.fname);
        int idCmp = (id > n.id) ? -1 : ((id < n.id) ? 1 : 0);
        
        return (cgpaCmp != 0 ? cgpaCmp :(fnameCmp !=0 ? fnameCmp : idCmp ));
    }
}
